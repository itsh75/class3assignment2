  ...
  <section className="facilities">
    ...
    <div className="row">
      <div className="facilities-col">
        <span id='img'><p><Image src="/course1.png" width={750} height={400} alt="Panaverse Dao Website"/></p></span>
      ...
      <div className="facilities-col">
      <span id='img'><p><Image src="/course2.png" width={750} height={400} alt="Panaverse Dao Website"/></p></span>
      ...
      <div className="facilities-col">
      <span id='img'><p><Image src="/course3.png" width={750} height={400} alt="Panaverse Dao Website"/></p></span>
        <h3>Data Science</h3>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio
          omnis asperiores atque aperiam.
